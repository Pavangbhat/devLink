...
// Get all posts
route.get("/posts", isAuthenticated, async (req, res) => {
...
// Get a post
route.get("/post/:id", isAuthenticated, (req, res) => {
...
// Delete a post
route.delete("/post/:id", isAuthenticated, (req, res) => {
  Post.findById(req.params.id)
    .then((post) => {
      if (!post) {
        return res.status(404).json({ msg: "Post not found" });
...
// Like a post
route.put("/post/like/:id", isAuthenticated, (req, res) => {
  Post.findById(req.params.id)
    .then((post) => {
      if (!post) {
        return res.status(404).json({ msg: "Post not found" });
...
// Unlike a post
route.put("/post/unlike/:id", isAuthenticated, (req, res) => {
  Post.findById(req.params.id)
    .then((post) => {
      if (!post) {
        return res.status(404).json({ msg: "Post not found" });
...
// Delete a comment
route.put("/post/:post_id/comment/:comment_id", isAuthenticated, (req, res) => {
